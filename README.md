...
> 📌 Сохрани скриншоты в папку `screenshots/` в корне проекта

| № | Страница | Описание |
|---|----------|----------|
| 1 | Главная (Hero) | Hero-секция с поиском и призывом к действию |
| 2 | Главная (список) | Карточки мероприятий |
| 3 | Регистрация | Форма регистрации |
| 4 | Авторизация | Форма входа |
| 5 | Детали мероприятия | Описание, состав, тип |
| 6 | Схема зала | Интерактивный выбор мест |
| 7 | Оформление | Выбранные места + кнопка оплаты |
| 8 | Профиль | Личные данные пользователя |
| 9 | Мои билеты | Список билетов с QR-кодами |
| 10 | Настройки | Смена пароля |
| 11 | Контакты | Форма обратной связи |
| 12 | Email | Письмо-подтверждение |
